...
def train_one_epoch(
    ...
    for images in data_loader:
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            ...
            loss, loss_ssl, loss_self_1, loss_self_2, loss_self_3, loss_item = (
                cads_loss(student_output, teacher_output, epoch)
            )
        ...
        if now_it % 100 == 0:
            print(
                "[{}/{}]\t[{}/{}]\ttotal_loss:{}\tloss_1:{}\tloss_2:{}\tloss_3:{}\tloss_4:{}\tlr:{}\tw:{}".format(
                    epoch,
                    args.epochs,
                    now_it,
                    len(data_loader),
...
class CADSLoss(nn.Module):
    ...
    def forward(self, student_output, teacher_output, epoch):
        ...
        teacher_out_self_4 = (
            F.softmax((teacher_output - self.center) / temp, dim=-1).detach().chunk(2)
        )
